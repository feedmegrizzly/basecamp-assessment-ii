...
//The new key should be 'faveColor' and set it to your favorite color as a string

me.faveColor="Blue";

// #3 Below is an object, 'message'. 
//Below it, add a 'text' key using bracket notation and assign it a string of whatever you would like.
...
var myFriends = ["Jim", "Anders", "Shayla", "Ben"];

// #6 Add a fifth friends name to the end of your myFriends array

myFriends.push("John");

// #7 Create a 'myArrayCopy' variable. It should equal the myArray variable. 
// Use the built in JavaScript method to create a copy.
//DON'T TOUCH THE CODE BELOW
var myArray = [1, 2, 3, 4];
//DON'T TOUCH THE CODE ABOVE
var myArrayCopy = myArray;
// #8 Below is an array, myNumbers. Create a function called 'evensOnly' that returns the 'evensArray' 
...
function indexFinder(){
  return randomNumbers.map((val, i) => i);
}
indexFinder();
